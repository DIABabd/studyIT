...
export const part3Questions: QuizQuestion[] = [
  ...
  // ============================================================
  // ADDITIONAL QUESTIONS — p3-126 through p3-168
  // ============================================================

  // --- group12: Nachhaltigkeit (6 more) ---
  {
    id: 'p3-126',
    exam: 'ap2',
    part: 'part3',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was versteht man unter dem Begriff "Triple Bottom Line" in der Nachhaltigkeit?',
      ar: 'ما المقصود بمفهوم "الخط الأساسي الثلاثي" في الاستدامة؟',
    },
    options: [
      { de: 'Die gleichzeitige Berücksichtigung von ökonomischen, ökologischen und sozialen Aspekten', ar: 'المراعاة المتزامنة للجوانب الاقتصادية والبيئية والاجتماعية' },
      { de: 'Die dreifache Gewinnmaximierung eines Unternehmens', ar: 'تحقيق أقصى ربح ثلاثي للشركة' },
      { de: 'Die Aufteilung des Gewinns auf drei Gesellschafter', ar: 'توزيع الأرباح على ثلاثة شركاء' },
      { de: 'Die Bilanzierung in drei verschiedenen Währungen', ar: 'إعداد الميزانية بثلاث عملات مختلفة' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Die Triple Bottom Line (People, Planet, Profit) beschreibt das Konzept, dass Unternehmen neben wirtschaftlichem Erfolg auch soziale Verantwortung und Umweltschutz berücksichtigen sollen.',
      ar: 'يصف الخط الأساسي الثلاثي (الناس، الكوكب، الربح) مفهوم أنه يجب على الشركات مراعاة المسؤولية الاجتماعية وحماية البيئة إلى جانب النجاح الاقتصادي.',
    },
  },
  {
    id: 'p3-127',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Welches Instrument gehört zur staatlichen Umweltpolitik?',
      ar: 'أي أداة تنتمي إلى السياسة البيئية الحكومية؟',
    },
    options: [
      { de: 'Der Emissionshandel (CO₂-Zertifikate)', ar: 'تجارة الانبعاثات (شهادات ثاني أكسيد الكربون)' },
      { de: 'Die Senkung des Mindestlohns', ar: 'تخفيض الحد الأدنى للأجور' },
      { de: 'Die Erhöhung der Arbeitszeit auf 50 Stunden pro Woche', ar: 'زيادة ساعات العمل إلى 50 ساعة أسبوعيًا' },
      { de: 'Die Abschaffung der Gewerbesteuer', ar: 'إلغاء ضريبة الأعمال' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Der Emissionshandel ist ein marktwirtschaftliches Instrument der Umweltpolitik. Unternehmen müssen für ihren CO₂-Ausstoß Zertifikate erwerben, was einen finanziellen Anreiz zur Emissionsreduktion schafft.',
      ar: 'تجارة الانبعاثات هي أداة اقتصادية سوقية للسياسة البيئية. يجب على الشركات شراء شهادات لانبعاثاتها من ثاني أكسيد الكربون مما يخلق حافزًا ماليًا لتقليل الانبعاثات.',
    },
  },
  {
    id: 'p3-128',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Welche Energiequelle zählt zu den erneuerbaren Energien?',
      ar: 'أي مصدر طاقة يُعد من مصادر الطاقة المتجددة؟',
    },
    options: [
      { de: 'Windkraft', ar: 'طاقة الرياح' },
      { de: 'Erdgas', ar: 'الغاز الطبيعي' },
      { de: 'Braunkohle', ar: 'الفحم البني' },
      { de: 'Erdöl', ar: 'النفط' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Windkraft ist eine erneuerbare Energiequelle, da Wind als natürliche Ressource unerschöpflich zur Verfügung steht. Erdgas, Braunkohle und Erdöl sind fossile, nicht erneuerbare Energieträger.',
      ar: 'طاقة الرياح هي مصدر طاقة متجدد لأن الرياح كمورد طبيعي متوفرة بشكل لا ينضب. الغاز الطبيعي والفحم البني والنفط هي حوامل طاقة أحفورية غير متجددة.',
    },
  },
  {
    id: 'p3-129',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was bedeutet "Corporate Social Responsibility" (CSR)?',
      ar: 'ما معنى "المسؤولية الاجتماعية للشركات"؟',
    },
    options: [
      { de: 'Die freiwillige Übernahme gesellschaftlicher Verantwortung durch Unternehmen über gesetzliche Anforderungen hinaus', ar: 'التزام الشركات الطوعي بالمسؤولية الاجتماعية بما يتجاوز المتطلبات القانونية' },
      { de: 'Die gesetzliche Pflicht zur Gewinnausschüttung an Aktionäre', ar: 'الالتزام القانوني بتوزيع الأرباح على المساهمين' },
      { de: 'Die Verpflichtung zur Einstellung von Schwerbehinderten', ar: 'الالتزام بتوظيف ذوي الإعاقات الشديدة' },
      { de: 'Die Pflicht zur Veröffentlichung von Quartalsberichten', ar: 'الالتزام بنشر التقارير الربع سنوية' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'CSR bezeichnet die freiwillige gesellschaftliche Verantwortung von Unternehmen, die über die Einhaltung gesetzlicher Bestimmungen hinausgeht, z. B. durch faire Arbeitsbedingungen, Umweltschutz oder soziales Engagement.',
      ar: 'تشير المسؤولية الاجتماعية للشركات إلى المسؤولية المجتمعية الطوعية للشركات التي تتجاوز الالتزام بالأحكام القانونية مثل ظروف العمل العادلة وحماية البيئة أو الالتزام الاجتماعي.',
    },
  },
  {
    id: 'p3-130',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was besagt das Verursacherprinzip in der Umweltpolitik?',
      ar: 'ما الذي ينص عليه مبدأ الملوث يدفع في السياسة البيئية؟',
    },
    options: [
      { de: 'Wer einen Umweltschaden verursacht, muss die Kosten der Beseitigung tragen.', ar: 'من يتسبب في ضرر بيئي يجب أن يتحمل تكاليف الإصلاح.' },
      { de: 'Der Staat übernimmt alle Kosten für Umweltschäden.', ar: 'تتحمل الدولة جميع تكاليف الأضرار البيئية.' },
      { de: 'Die Verbraucher tragen immer die Umweltkosten.', ar: 'يتحمل المستهلكون دائمًا التكاليف البيئية.' },
      { de: 'Umweltschäden werden nur bei Vorsatz bestraft.', ar: 'يتم معاقبة الأضرار البيئية فقط في حالة القصد.' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Das Verursacherprinzip (Polluter Pays Principle) ist ein Grundsatz der Umweltpolitik, wonach derjenige die Kosten für Umweltschäden tragen muss, der sie verursacht hat.',
      ar: 'مبدأ الملوث يدفع هو أساس في السياسة البيئية ينص على أن من يتسبب في أضرار بيئية يجب أن يتحمل تكاليفها.',
    },
  },
  {
    id: 'p3-131',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Welches Ziel verfolgt das Erneuerbare-Energien-Gesetz (EEG)?',
      ar: 'ما الهدف الذي يسعى إليه قانون الطاقة المتجددة؟',
    },
    options: [
      { de: 'Den Anteil erneuerbarer Energien an der Stromversorgung deutlich zu steigern', ar: 'زيادة حصة الطاقات المتجددة في إمدادات الكهرباء بشكل كبير' },
      { de: 'Die Förderung fossiler Energieträger zu erhöhen', ar: 'زيادة دعم حوامل الطاقة الأحفورية' },
      { de: 'Den Strompreis für Unternehmen zu senken', ar: 'تخفيض سعر الكهرباء للشركات' },
      { de: 'Die Kernenergie langfristig auszubauen', ar: 'توسيع الطاقة النووية على المدى الطويل' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Das EEG fördert den Ausbau erneuerbarer Energien (Wind, Solar, Biomasse, Wasserkraft) mit dem Ziel, den Anteil an der Stromversorgung kontinuierlich zu steigern und CO₂-Emissionen zu reduzieren.',
      ar: 'يعزز قانون الطاقة المتجددة توسيع مصادر الطاقة المتجددة (الرياح والطاقة الشمسية والكتلة الحيوية والطاقة المائية) بهدف زيادة حصتها في إمدادات الكهرباء بشكل مستمر وتقليل انبعاثات ثاني أكسيد الكربون.',
    },
  },

  // --- group13: International trade (6 more) ---
  {
    id: 'p3-132',
    exam: 'ap2',
    part: 'part3',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was versteht man unter einer Einfuhrkontingentierung?',
      ar: 'ما المقصود بنظام الحصص على الواردات؟',
    },
    options: [
      { de: 'Eine mengenmäßige Beschränkung der Einfuhr bestimmter Waren', ar: 'تقييد كمي لاستيراد سلع معينة' },
      { de: 'Eine Erhöhung der Einfuhrzölle auf alle Waren', ar: 'زيادة الرسوم الجمركية على جميع السلع' },
      { de: 'Ein Verbot aller Importe aus einem bestimmten Land', ar: 'حظر جميع الواردات من بلد معين' },
      { de: 'Eine Subventionierung der inländischen Exportwirtschaft', ar: 'دعم الاقتصاد التصديري المحلي' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Eine Einfuhrkontingentierung (Importquote) begrenzt die Menge bestimmter Waren, die innerhalb eines Zeitraums importiert werden dürfen. Sie ist ein Instrument der Außenhandelspolitik zum Schutz der heimischen Wirtschaft.',
      ar: 'نظام الحصص على الواردات يحد من كمية سلع معينة يمكن استيرادها خلال فترة زمنية معينة. وهو أداة من أدوات سياسة التجارة الخارجية لحماية الاقتصاد المحلي.',
    },
  },
  {
    id: 'p3-133',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Welchen Vorteil hat eine Exportförderung für die heimische Wirtschaft?',
      ar: 'ما الفائدة التي يحققها دعم التصدير للاقتصاد المحلي؟',
    },
    options: [
      { de: 'Steigerung der Wettbewerbsfähigkeit heimischer Unternehmen auf dem Weltmarkt', ar: 'تعزيز القدرة التنافسية للشركات المحلية في السوق العالمية' },
      { de: 'Senkung der Importpreise für Verbraucher', ar: 'خفض أسعار الواردات للمستهلكين' },
      { de: 'Verringerung der Staatsverschuldung', ar: 'تقليل الديون الحكومية' },
      { de: 'Abschaffung aller Handelshemmnisse', ar: 'إلغاء جميع العوائق التجارية' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Durch Exportförderung (z. B. Exportkreditgarantien, Hermes-Bürgschaften) werden heimische Unternehmen im internationalen Wettbewerb gestärkt, was zu mehr Exporteinnahmen und Arbeitsplätzen führen kann.',
      ar: 'من خلال دعم التصدير (مثل ضمانات ائتمان التصدير وكفالات هيرمس) يتم تعزيز الشركات المحلية في المنافسة الدولية مما يمكن أن يؤدي إلى مزيد من إيرادات التصدير وفرص العمل.',
    },
  },
  {
    id: 'p3-134',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was ist der Hauptzweck von Schutzzöllen?',
      ar: 'ما الغرض الرئيسي من الرسوم الجمركية الوقائية؟',
    },
    options: [
      { de: 'Schutz der inländischen Wirtschaft vor günstigeren ausländischen Produkten', ar: 'حماية الاقتصاد المحلي من المنتجات الأجنبية الأرخص' },
      { de: 'Erhöhung der Exporte in andere Länder', ar: 'زيادة الصادرات إلى بلدان أخرى' },
      { de: 'Förderung des freien Welthandels', ar: 'تعزيز التجارة العالمية الحرة' },
      { de: 'Senkung der Verbraucherpreise im Inland', ar: 'خفض أسعار المستهلكين في الداخل' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Schutzzölle (protektionistische Zölle) verteuern importierte Waren, um die heimische Produktion vor günstigerer ausländischer Konkurrenz zu schützen.',
      ar: 'الرسوم الجمركية الوقائية (الحمائية) ترفع أسعار السلع المستوردة لحماية الإنتاج المحلي من المنافسة الأجنبية الأرخص.',
    },
  },
  {
    id: 'p3-135',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was versteht man unter der Handelsbilanz eines Landes?',
      ar: 'ما المقصود بالميزان التجاري لبلد ما؟',
    },
    options: [
      { de: 'Die Gegenüberstellung von Warenexporten und Warenimporten', ar: 'مقارنة صادرات السلع وواردات السلع' },
      { de: 'Die Gesamtheit aller Steuereinnahmen des Staates', ar: 'مجموع جميع الإيرادات الضريبية للدولة' },
      { de: 'Die Summe aller Unternehmensgewinne', ar: 'مجموع جميع أرباح الشركات' },
      { de: 'Die Aufstellung aller Auslandsinvestitionen', ar: 'قائمة جميع الاستثمارات الأجنبية' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Die Handelsbilanz stellt den Wert der exportierten Waren dem Wert der importierten Waren gegenüber. Übersteigen die Exporte die Importe, spricht man von einem Handelsbilanzüberschuss.',
      ar: 'الميزان التجاري يقارن قيمة السلع المصدرة بقيمة السلع المستوردة. إذا تجاوزت الصادرات الواردات يُقال إن هناك فائضًا في الميزان التجاري.',
    },
  },
  {
    id: 'p3-136',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was sind "Incoterms" im internationalen Handel?',
      ar: 'ما هي "مصطلحات التجارة الدولية" في التجارة الدولية؟',
    },
    options: [
      { de: 'Standardisierte Handelsklauseln, die Rechte und Pflichten von Käufer und Verkäufer bei internationalen Lieferungen regeln', ar: 'بنود تجارية موحدة تنظم حقوق وواجبات المشتري والبائع في عمليات التسليم الدولية' },
      { de: 'Internationale Steuersätze für den grenzüberschreitenden Handel', ar: 'معدلات ضريبية دولية للتجارة عبر الحدود' },
      { de: 'Vorschriften der Weltbank zur Kreditvergabe', ar: 'قواعد البنك الدولي لمنح القروض' },
      { de: 'Die offiziellen Amtssprachen der Vereinten Nationen', ar: 'اللغات الرسمية للأمم المتحدة' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Incoterms (International Commercial Terms) werden von der Internationalen Handelskammer (ICC) herausgegeben und regeln u. a. Gefahrenübergang, Transportkosten und Versicherungspflichten bei internationalen Warenlieferungen (z. B. FOB, CIF, EXW).',
      ar: 'مصطلحات التجارة الدولية تصدرها غرفة التجارة الدولية وتنظم من بين أمور أخرى انتقال المخاطر وتكاليف النقل والتزامات التأمين في عمليات تسليم السلع الدولية (مثل FOB و CIF و EXW).',
    },
  },
  {
    id: 'p3-137',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was ist ein Finanzzoll?',
      ar: 'ما هو الرسم الجمركي المالي؟',
    },
    options: [
      { de: 'Ein Zoll, der vorrangig zur Erzielung von Staatseinnahmen erhoben wird', ar: 'رسم جمركي يُفرض بشكل رئيسي لتحقيق إيرادات للدولة' },
      { de: 'Ein Zoll, der nur auf Finanzdienstleistungen erhoben wird', ar: 'رسم جمركي يُفرض فقط على الخدمات المالية' },
      { de: 'Eine Gebühr für die Nutzung von Bankdienstleistungen', ar: 'رسم لاستخدام الخدمات البنكية' },
      { de: 'Eine Steuer auf Finanztransaktionen an der Börse', ar: 'ضريبة على المعاملات المالية في البورصة' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Ein Finanzzoll dient primär der Erzielung von Staatseinnahmen, im Gegensatz zum Schutzzoll, der den Schutz der heimischen Wirtschaft bezweckt. Finanzzölle werden oft auf Waren erhoben, die im Inland nicht hergestellt werden.',
      ar: 'الرسم الجمركي المالي يخدم بشكل أساسي تحقيق إيرادات للدولة على عكس الرسم الجمركي الوقائي الذي يهدف إلى حماية الاقتصاد المحلي. غالبًا ما تُفرض الرسوم المالية على سلع لا تُنتج محليًا.',
    },
  },

  // --- group14: Digital economy (6 more) ---
  {
    id: 'p3-138',
    exam: 'ap2',
    part: 'part3',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was versteht man unter "Big Data"?',
      ar: 'ما المقصود بـ "البيانات الضخمة"؟',
    },
    options: [
      { de: 'Die Verarbeitung und Analyse sehr großer und komplexer Datenmengen, die mit herkömmlichen Methoden nicht handhabbar sind', ar: 'معالجة وتحليل كميات كبيرة جدًا ومعقدة من البيانات لا يمكن التعامل معها بالطرق التقليدية' },
      { de: 'Die Speicherung aller Daten auf einer einzelnen Festplatte', ar: 'تخزين جميع البيانات على قرص صلب واحد' },
      { de: 'Die Verschlüsselung aller Unternehmensdaten', ar: 'تشفير جميع بيانات الشركة' },
      { de: 'Die Löschung alter Datenbestände', ar: 'حذف مخزونات البيانات القديمة' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Big Data bezeichnet extrem große Datenmengen, die durch Volumen, Geschwindigkeit und Vielfalt (Volume, Velocity, Variety) gekennzeichnet sind und mit speziellen Technologien analysiert werden.',
      ar: 'البيانات الضخمة تشير إلى كميات بيانات كبيرة للغاية تتميز بالحجم والسرعة والتنوع ويتم تحليلها بتقنيات خاصة.',
    },
  },
  {
    id: 'p3-139',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Welches Konzept ist zentral für Industrie 4.0?',
      ar: 'أي مفهوم يعد محوريًا للصناعة 4.0؟',
    },
    options: [
      { de: 'Die Vernetzung von Maschinen und Produkten über das Internet der Dinge (IoT)', ar: 'ربط الآلات والمنتجات عبر إنترنت الأشياء' },
      { de: 'Die Rückkehr zur manuellen Fertigung', ar: 'العودة إلى التصنيع اليدوي' },
      { de: 'Die Abschaffung digitaler Kommunikation', ar: 'إلغاء الاتصالات الرقمية' },
      { de: 'Die Verlagerung aller Arbeitsplätze ins Ausland', ar: 'نقل جميع الوظائف إلى الخارج' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Industrie 4.0 (die vierte industrielle Revolution) basiert auf der intelligenten Vernetzung von Maschinen, Anlagen und Produkten über das IoT. Ziel ist eine selbstorganisierte, flexible Produktion (Smart Factory).',
      ar: 'الصناعة 4.0 (الثورة الصناعية الرابعة) تعتمد على الربط الذكي للآلات والمنشآت والمنتجات عبر إنترنت الأشياء. الهدف هو إنتاج ذاتي التنظيم ومرن (المصنع الذكي).',
    },
  },
  {
    id: 'p3-140',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Welche Auswirkung hat die Automatisierung häufig auf den Arbeitsmarkt?',
      ar: 'ما التأثير الذي تحدثه الأتمتة في الغالب على سوق العمل؟',
    },
    options: [
      { de: 'Routineaufgaben werden durch Maschinen ersetzt, während die Nachfrage nach qualifizierten Fachkräften steigt', ar: 'يتم استبدال المهام الروتينية بالآلات بينما يزداد الطلب على العمالة المؤهلة' },
      { de: 'Alle Arbeitsplätze werden vollständig abgeschafft', ar: 'يتم إلغاء جميع الوظائف بالكامل' },
      { de: 'Die Löhne sinken für alle Beschäftigten', ar: 'تنخفض الأجور لجميع الموظفين' },
      { de: 'Der Bedarf an Weiterbildung nimmt ab', ar: 'ينخفض الحاجة إلى التعليم المستمر' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Automatisierung ersetzt vor allem einfache, repetitive Tätigkeiten. Gleichzeitig entstehen neue Berufsfelder und die Nachfrage nach IT-Fachkräften und qualifizierten Arbeitnehmern steigt.',
      ar: 'تحل الأتمتة محل الأنشطة البسيطة والمتكررة بشكل رئيسي. وفي الوقت نفسه تنشأ مجالات مهنية جديدة ويزداد الطلب على متخصصي تكنولوجيا المعلومات والعمالة المؤهلة.',
    },
  },
  {
    id: 'p3-141',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was ist ein Vorteil von Cloud Computing für Unternehmen?',
      ar: 'ما ميزة الحوسبة السحابية للشركات؟',
    },
    options: [
      { de: 'Flexible Skalierung von IT-Ressourcen ohne hohe Anfangsinvestitionen', ar: 'توسيع مرن لموارد تكنولوجيا المعلومات بدون استثمارات أولية عالية' },
      { de: 'Vollständige Unabhängigkeit vom Internet', ar: 'استقلال تام عن الإنترنت' },
      { de: 'Garantierter Schutz vor allen Cyberangriffen', ar: 'حماية مضمونة من جميع الهجمات الإلكترونية' },
      { de: 'Automatische Einhaltung aller Datenschutzgesetze', ar: 'الامتثال التلقائي لجميع قوانين حماية البيانات' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Cloud Computing ermöglicht es Unternehmen, IT-Ressourcen (Speicher, Rechenleistung, Software) nach Bedarf zu nutzen, ohne eigene Server anschaffen zu müssen. Die Kosten sind variabel und skalierbar.',
      ar: 'تتيح الحوسبة السحابية للشركات استخدام موارد تكنولوجيا المعلومات (التخزين وقوة الحوسبة والبرمجيات) حسب الحاجة دون الحاجة لشراء خوادم خاصة. التكاليف متغيرة وقابلة للتوسع.',
    },
  },
  {
    id: 'p3-142',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was ist ein "digitaler Zwilling" im Kontext von Industrie 4.0?',
      ar: 'ما هو "التوأم الرقمي" في سياق الصناعة 4.0؟',
    },
    options: [
      { de: 'Ein virtuelles Abbild eines realen Produkts oder Prozesses zur Simulation und Optimierung', ar: 'نسخة افتراضية من منتج أو عملية حقيقية للمحاكاة والتحسين' },
      { de: 'Eine Kopie der Unternehmenssoftware als Backup', ar: 'نسخة من برنامج الشركة كنسخة احتياطية' },
      { de: 'Ein zweiter identischer Roboter in der Produktion', ar: 'روبوت ثانٍ متطابق في الإنتاج' },
      { de: 'Die doppelte Datenspeicherung auf zwei Servern', ar: 'تخزين البيانات مزدوج على خادمين' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Ein digitaler Zwilling ist ein virtuelles Modell eines physischen Objekts oder Prozesses. Er ermöglicht Simulationen, vorausschauende Wartung (Predictive Maintenance) und Prozessoptimierung in Echtzeit.',
      ar: 'التوأم الرقمي هو نموذج افتراضي لكائن أو عملية فعلية. يتيح المحاكاة والصيانة التنبؤية وتحسين العمليات في الوقت الفعلي.',
    },
  },
  {
    id: 'p3-143',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was versteht man unter "Robotic Process Automation" (RPA)?',
      ar: 'ما المقصود بـ "أتمتة العمليات الروبوتية"؟',
    },
    options: [
      { de: 'Die Automatisierung wiederkehrender Geschäftsprozesse durch Softwareroboter', ar: 'أتمتة العمليات التجارية المتكررة بواسطة روبوتات برمجية' },
      { de: 'Den Einsatz physischer Roboter im Büro', ar: 'استخدام روبوتات مادية في المكتب' },
      { de: 'Die automatische Reparatur von Maschinen', ar: 'الإصلاح التلقائي للآلات' },
      { de: 'Die Fernsteuerung von Produktionsanlagen', ar: 'التحكم عن بعد في منشآت الإنتاج' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'RPA nutzt Softwareroboter (Bots), um regelbasierte, repetitive Aufgaben zu automatisieren, z. B. Dateneingabe, Rechnungsbearbeitung oder Berichterstellung. Dies spart Zeit und reduziert Fehler.',
      ar: 'تستخدم أتمتة العمليات الروبوتية روبوتات برمجية لأتمتة المهام المتكررة القائمة على قواعد مثل إدخال البيانات ومعالجة الفواتير أو إعداد التقارير مما يوفر الوقت ويقلل الأخطاء.',
    },
  },

  // --- group11: Datenschutz (5 more) ---
  {
    id: 'p3-144',
    exam: 'ap2',
    part: 'part3',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Welches Recht haben betroffene Personen nach der DSGVO in Bezug auf ihre gespeicherten Daten?',
      ar: 'ما الحق الذي يتمتع به الأشخاص المعنيون وفقًا للائحة حماية البيانات العامة فيما يتعلق ببياناتهم المخزنة؟',
    },
    options: [
      { de: 'Das Recht auf Auskunft über die gespeicherten personenbezogenen Daten', ar: 'الحق في الاستعلام عن البيانات الشخصية المخزنة' },
      { de: 'Das Recht auf Einsicht in alle Unternehmensdaten', ar: 'الحق في الاطلاع على جميع بيانات الشركة' },
      { de: 'Das Recht auf kostenlose Rechtsberatung', ar: 'الحق في استشارة قانونية مجانية' },
      { de: 'Das Recht auf Zugang zu den Daten anderer Personen', ar: 'الحق في الوصول إلى بيانات أشخاص آخرين' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Artikel 15 DSGVO gewährt betroffenen Personen ein umfassendes Auskunftsrecht. Sie können erfahren, welche Daten über sie gespeichert sind, zu welchem Zweck und an wen sie weitergegeben wurden.',
      ar: 'تمنح المادة 15 من اللائحة العامة لحماية البيانات الأشخاص المعنيين حق استعلام شامل. يمكنهم معرفة البيانات المخزنة عنهم ولأي غرض ولمن تم تمريرها.',
    },
  },
  {
    id: 'p3-145',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Ab welcher Anzahl von Beschäftigten, die ständig mit personenbezogener Datenverarbeitung beschäftigt sind, muss ein Datenschutzbeauftragter bestellt werden?',
      ar: 'ابتداءً من أي عدد من الموظفين المشغولين بشكل دائم بمعالجة البيانات الشخصية يجب تعيين مسؤول حماية البيانات؟',
    },
    options: [
      { de: 'Ab 20 Personen', ar: 'ابتداءً من 20 شخصًا' },
      { de: 'Ab 5 Personen', ar: 'ابتداءً من 5 أشخاص' },
      { de: 'Ab 50 Personen', ar: 'ابتداءً من 50 شخصًا' },
      { de: 'Ab 100 Personen', ar: 'ابتداءً من 100 شخص' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Nach § 38 BDSG muss ein Datenschutzbeauftragter bestellt werden, wenn mindestens 20 Personen ständig mit der automatisierten Verarbeitung personenbezogener Daten beschäftigt sind.',
      ar: 'وفقًا للمادة 38 من القانون الاتحادي لحماية البيانات يجب تعيين مسؤول حماية بيانات إذا كان 20 شخصًا على الأقل مشغولين بشكل دائم بالمعالجة الآلية للبيانات الشخصية.',
    },
  },
  {
    id: 'p3-146',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Welche der folgenden Daten gelten nach DSGVO als "besondere Kategorien personenbezogener Daten"?',
      ar: 'أي من البيانات التالية تعتبر وفقًا للائحة حماية البيانات العامة "فئات خاصة من البيانات الشخصية"؟',
    },
    options: [
      { de: 'Gesundheitsdaten und biometrische Daten', ar: 'البيانات الصحية والبيانات البيومترية' },
      { de: 'Name und Vorname', ar: 'الاسم الأخير والاسم الأول' },
      { de: 'E-Mail-Adresse und Telefonnummer', ar: 'عنوان البريد الإلكتروني ورقم الهاتف' },
      { de: 'Postanschrift und Geburtsdatum', ar: 'العنوان البريدي وتاريخ الميلاد' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Artikel 9 DSGVO definiert besondere Kategorien: rassische/ethnische Herkunft, politische Meinungen, religiöse Überzeugungen, Gewerkschaftszugehörigkeit, genetische und biometrische Daten, Gesundheitsdaten sowie Daten zum Sexualleben. Diese unterliegen einem grundsätzlichen Verarbeitungsverbot.',
      ar: 'تحدد المادة 9 من اللائحة العامة لحماية البيانات فئات خاصة: الأصل العرقي والآراء السياسية والمعتقدات الدينية والانتماء النقابي والبيانات الجينية والبيومترية والبيانات الصحية وبيانات الحياة الجنسية. هذه تخضع لحظر معالجة أساسي.',
    },
  },
  {
    id: 'p3-147',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Welche technische Maßnahme dient der Datensicherheit gemäß DSGVO?',
      ar: 'أي إجراء تقني يخدم أمن البيانات وفقًا للائحة حماية البيانات العامة؟',
    },
    options: [
      { de: 'Verschlüsselung personenbezogener Daten bei der Übertragung', ar: 'تشفير البيانات الشخصية أثناء النقل' },
      { de: 'Veröffentlichung aller Daten im Internet', ar: 'نشر جميع البيانات على الإنترنت' },
      { de: 'Verwendung einfacher Passwörter für alle Mitarbeiter', ar: 'استخدام كلمات مرور بسيطة لجميع الموظفين' },
      { de: 'Speicherung aller Daten ohne Zugangsbeschränkung', ar: 'تخزين جميع البيانات بدون قيود وصول' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Die DSGVO fordert in Art. 32 technische und organisatorische Maßnahmen (TOMs) zum Schutz personenbezogener Daten, z. B. Verschlüsselung, Pseudonymisierung, Zugangskontrollen und regelmäßige Sicherheitstests.',
      ar: 'تتطلب اللائحة العامة لحماية البيانات في المادة 32 إجراءات تقنية وتنظيمية لحماية البيانات الشخصية مثل التشفير والتسمية المستعارة وضوابط الوصول واختبارات الأمان المنتظمة.',
    },
  },
  {
    id: 'p3-148',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Welche Frist gilt nach der DSGVO für die Meldung einer Datenpanne an die Aufsichtsbehörde?',
      ar: 'ما المهلة المحددة وفقًا للائحة حماية البيانات العامة للإبلاغ عن خرق بيانات لهيئة الرقابة؟',
    },
    options: [
      { de: '72 Stunden nach Bekanntwerden der Verletzung', ar: '72 ساعة بعد العلم بالانتهاك' },
      { de: '7 Tage nach Bekanntwerden der Verletzung', ar: '7 أيام بعد العلم بالانتهاك' },
      { de: '30 Tage nach Bekanntwerden der Verletzung', ar: '30 يومًا بعد العلم بالانتهاك' },
      { de: 'Keine Frist – Meldung ist freiwillig', ar: 'لا توجد مهلة - الإبلاغ طوعي' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Nach Art. 33 DSGVO muss eine Verletzung des Schutzes personenbezogener Daten unverzüglich und möglichst innerhalb von 72 Stunden nach Bekanntwerden der zuständigen Aufsichtsbehörde gemeldet werden.',
      ar: 'وفقًا للمادة 33 من اللائحة العامة لحماية البيانات يجب الإبلاغ عن انتهاك حماية البيانات الشخصية فورًا وفي غضون 72 ساعة إن أمكن بعد العلم به إلى هيئة الرقابة المختصة.',
    },
  },

  // --- group02: Mitbestimmung (4 more) ---
  {
    id: 'p3-149',
    exam: 'ap2',
    part: 'part3',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Ab wie vielen ständig wahlberechtigten Arbeitnehmern kann in einem Betrieb ein Betriebsrat gewählt werden?',
      ar: 'ابتداءً من كم عامل دائم يحق لهم التصويت يمكن انتخاب مجلس عمال في المنشأة؟',
    },
    options: [
      { de: 'Ab 5 wahlberechtigten Arbeitnehmern, von denen 3 wählbar sind', ar: 'ابتداءً من 5 عمال يحق لهم التصويت منهم 3 قابلون للانتخاب' },
      { de: 'Ab 10 wahlberechtigten Arbeitnehmern', ar: 'ابتداءً من 10 عمال يحق لهم التصويت' },
      { de: 'Ab 20 wahlberechtigten Arbeitnehmern', ar: 'ابتداءً من 20 عاملاً يحق لهم التصويت' },
      { de: 'Ab 50 wahlberechtigten Arbeitnehmern', ar: 'ابتداءً من 50 عاملاً يحق لهم التصويت' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Nach § 1 BetrVG können in Betrieben mit mindestens fünf ständigen wahlberechtigten Arbeitnehmern, von denen drei wählbar sind, Betriebsräte gewählt werden.',
      ar: 'وفقًا للمادة 1 من قانون تنظيم العمل يمكن انتخاب مجالس عمال في المنشآت التي تضم 5 عمال دائمين على الأقل يحق لهم التصويت ومنهم 3 قابلون للانتخاب.',
    },
  },
  {
    id: 'p3-150',
    ...
    type: 'multiple-choice',
    question: {
      de: 'In welcher Angelegenheit hat der Betriebsrat ein zwingendes Mitbestimmungsrecht?',
      ar: 'في أي شأن يتمتع مجلس العمال بحق مشاركة إلزامي؟',
    },
    options: [
      { de: 'Festlegung von Beginn und Ende der täglichen Arbeitszeit', ar: 'تحديد بداية ونهاية وقت العمل اليومي' },
      { de: 'Festlegung der Produktpreise', ar: 'تحديد أسعار المنتجات' },
      { de: 'Auswahl der Geschäftsführung', ar: 'اختيار إدارة الشركة' },
      { de: 'Entscheidung über Investitionen', ar: 'اتخاذ قرارات بشأن الاستثمارات' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Nach § 87 Abs. 1 Nr. 2 BetrVG hat der Betriebsrat ein zwingendes Mitbestimmungsrecht bei Beginn und Ende der täglichen Arbeitszeit einschließlich der Pausen sowie der Verteilung der Arbeitszeit auf die einzelnen Wochentage.',
      ar: 'وفقًا للمادة 87 فقرة 1 رقم 2 من قانون تنظيم العمل يتمتع مجلس العمال بحق مشاركة إلزامي في تحديد بداية ونهاية وقت العمل اليومي بما في ذلك فترات الراحة وتوزيع ساعات العمل على أيام الأسبوع.',
    },
  },
  {
    id: 'p3-151',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Wer darf die Jugend- und Auszubildendenvertretung (JAV) wählen?',
      ar: 'من يحق له انتخاب ممثلي الشباب والمتدربين؟',
    },
    options: [
      { de: 'Alle Arbeitnehmer unter 18 Jahren sowie alle Auszubildenden unter 25 Jahren', ar: 'جميع العمال تحت سن 18 عامًا وجميع المتدربين تحت سن 25 عامًا' },
      { de: 'Nur Arbeitnehmer über 18 Jahren', ar: 'فقط العمال فوق 18 عامًا' },
      { de: 'Alle Arbeitnehmer des Betriebs unabhängig vom Alter', ar: 'جميع عمال المنشأة بغض النظر عن العمر' },
      { de: 'Nur die Geschäftsführung', ar: 'فقط إدارة الشركة' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Nach § 60 BetrVG werden Jugend- und Auszubildendenvertretungen in Betrieben gewählt, in denen mindestens fünf Arbeitnehmer unter 18 Jahren oder Auszubildende unter 25 Jahren beschäftigt sind. Wahlberechtigt sind diese Personengruppen.',
      ar: 'وفقًا للمادة 60 من قانون تنظيم العمل يتم انتخاب ممثلي الشباب والمتدربين في المنشآت التي يعمل فيها 5 عمال على الأقل تحت سن 18 أو متدربين تحت سن 25. ويحق لهذه المجموعات التصويت.',
    },
  },
  {
    id: 'p3-152',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Wie oft muss der Betriebsrat eine ordentliche Betriebsversammlung einberufen?',
      ar: 'كم مرة يجب على مجلس العمال عقد اجتماع عمال عادي؟',
    },
    options: [
      { de: 'Einmal im Kalendervierteljahr (vierteljährlich)', ar: 'مرة واحدة في كل ربع سنة تقويمية' },
      { de: 'Einmal im Monat', ar: 'مرة واحدة في الشهر' },
      { de: 'Einmal im Kalenderjahr', ar: 'مرة واحدة في السنة التقويمية' },
      { de: 'Nur auf Antrag der Geschäftsführung', ar: 'فقط بناءً على طلب إدارة الشركة' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Nach § 43 Abs. 1 BetrVG hat der Betriebsrat einmal in jedem Kalendervierteljahr eine Betriebsversammlung einzuberufen und in ihr einen Tätigkeitsbericht zu erstatten.',
      ar: 'وفقًا للمادة 43 فقرة 1 من قانون تنظيم العمل يجب على مجلس العمال عقد اجتماع عمال مرة في كل ربع سنة تقويمية وتقديم تقرير نشاط فيه.',
    },
  },

  // --- group05: Wirtschaftskreislauf (4 more) ---
  {
    id: 'p3-153',
    exam: 'ap2',
    part: 'part3',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Welche Rolle spielen Banken im erweiterten Wirtschaftskreislauf?',
      ar: 'ما الدور الذي تلعبه البنوك في الدورة الاقتصادية الموسعة؟',
    },
    options: [
      { de: 'Sie sammeln Ersparnisse und vergeben Kredite, wodurch sie als Kapitalsammelstellen fungieren', ar: 'تجمع المدخرات وتمنح القروض بحيث تعمل كمراكز تجميع رأس المال' },
      { de: 'Sie produzieren Waren für den Export', ar: 'تنتج سلعًا للتصدير' },
      { de: 'Sie erheben Steuern im Auftrag des Staates', ar: 'تفرض ضرائب بتكليف من الدولة' },
      { de: 'Sie stellen Arbeitnehmer für andere Unternehmen ein', ar: 'توظف عمالاً لحساب شركات أخرى' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Im erweiterten Wirtschaftskreislauf sind Banken (Kapitalsammelstellen) Vermittler zwischen Sparern und Kreditnehmern. Sie nehmen Spareinlagen an und vergeben Kredite, wodurch sie den Geldkreislauf in Gang halten.',
      ar: 'في الدورة الاقتصادية الموسعة تعمل البنوك (مراكز تجميع رأس المال) كوسيط بين المدخرين والمقترضين. تستقبل الودائع الادخارية وتمنح القروض مما يحافظ على استمرار الدورة النقدية.',
    },
  },
  {
    id: 'p3-154',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Welche Ströme fließen im Wirtschaftskreislauf vom Staat zu den Haushalten?',
      ar: 'ما التدفقات التي تنتقل في الدورة الاقتصادية من الدولة إلى الأسر؟',
    },
    options: [
      { de: 'Transferleistungen (z. B. Kindergeld, Arbeitslosengeld) und öffentliche Güter', ar: 'مدفوعات التحويل (مثل علاوة الأطفال وإعانة البطالة) والسلع العامة' },
      { de: 'Steuern und Sozialabgaben', ar: 'الضرائب والاشتراكات الاجتماعية' },
      { de: 'Exporterlöse und Zolleinnahmen', ar: 'عائدات التصدير وإيرادات الجمارك' },
      { de: 'Zinsen auf Unternehmenskredite', ar: 'فوائد قروض الشركات' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Der Staat zahlt an Haushalte Transferleistungen (Sozialleistungen wie Kindergeld, Wohngeld, Arbeitslosengeld) und stellt öffentliche Güter bereit (Infrastruktur, Bildung, Sicherheit). Umgekehrt fließen Steuern und Abgaben von den Haushalten zum Staat.',
      ar: 'تدفع الدولة للأسر مدفوعات التحويل (إعانات اجتماعية مثل علاوة الأطفال وبدل السكن وإعانة البطالة) وتوفر سلعًا عامة (البنية التحتية والتعليم والأمن). وفي المقابل تتدفق الضرائب والاشتراكات من الأسر إلى الدولة.',
    },
  },
  {
    id: 'p3-155',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was fließt im einfachen Wirtschaftskreislauf von den Unternehmen zu den Haushalten?',
      ar: 'ما الذي يتدفق في الدورة الاقتصادية البسيطة من الشركات إلى الأسر؟',
    },
    options: [
      { de: 'Konsumgüter und Dienstleistungen (Güterstrom) sowie Einkommen (Geldstrom)', ar: 'السلع الاستهلاكية والخدمات (تدفق السلع) والدخل (تدفق نقدي)' },
      { de: 'Steuern und Abgaben', ar: 'الضرائب والرسوم' },
      { de: 'Rohstoffe und Vorprodukte', ar: 'المواد الخام والمنتجات الوسيطة' },
      { de: 'Kredite und Darlehen', ar: 'القروض والسلف' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Im einfachen Wirtschaftskreislauf (Zwei-Sektoren-Modell) liefern Unternehmen Konsumgüter und Dienstleistungen an die Haushalte (Güterstrom) und zahlen ihnen Einkommen wie Löhne, Gehälter, Mieten und Zinsen (Geldstrom).',
      ar: 'في الدورة الاقتصادية البسيطة (نموذج القطاعين) تقدم الشركات سلعًا استهلاكية وخدمات للأسر (تدفق السلع) وتدفع لهم الدخل مثل الأجور والرواتب والإيجارات والفوائد (تدفق نقدي).',
    },
  },
  {
    id: 'p3-156',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was passiert im Wirtschaftskreislauf, wenn die Sparquote der Haushalte steigt und die Investitionen der Unternehmen gleichbleiben?',
      ar: 'ماذا يحدث في الدورة الاقتصادية عندما يرتفع معدل ادخار الأسر وتبقى استثمارات الشركات ثابتة؟',
    },
    options: [
      { de: 'Die Konsumnachfrage sinkt, was zu einem Rückgang der Produktion führen kann', ar: 'ينخفض الطلب الاستهلاكي مما قد يؤدي إلى تراجع الإنتاج' },
      { de: 'Die Exporte steigen automatisch', ar: 'ترتفع الصادرات تلقائيًا' },
      { de: 'Die Steuereinnahmen des Staates steigen', ar: 'ترتفع الإيرادات الضريبية للدولة' },
      { de: 'Die Löhne steigen sofort', ar: 'ترتفع الأجور فورًا' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Wenn Haushalte mehr sparen, sinkt der Konsum. Ohne entsprechend steigende Investitionen entsteht eine Nachfragelücke, die zu Produktionsrückgang und möglicherweise steigender Arbeitslosigkeit führen kann (Sparparadoxon).',
      ar: 'عندما تدخر الأسر أكثر ينخفض الاستهلاك. بدون ارتفاع مقابل في الاستثمارات تنشأ فجوة في الطلب يمكن أن تؤدي إلى تراجع الإنتاج وربما ارتفاع البطالة (مفارقة الادخار).',
    },
  },

  // --- group06: Unternehmensorganisation (4 more) ---
  {
    id: 'p3-157',
    exam: 'ap2',
    part: 'part3',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Welcher Nachteil wird der Matrixorganisation häufig zugeschrieben?',
      ar: 'أي عيب يُنسب في الغالب إلى التنظيم المصفوفي؟',
    },
    options: [
      { de: 'Kompetenzkonflikte durch Mehrfachunterstellung der Mitarbeiter', ar: 'تضارب الصلاحيات بسبب خضوع الموظفين لعدة رؤساء' },
      { de: 'Zu wenig Kommunikation zwischen Abteilungen', ar: 'قلة التواصل بين الأقسام' },
      { de: 'Fehlende Spezialisierung der Mitarbeiter', ar: 'غياب التخصص لدى الموظفين' },
      { de: 'Zu einfache Entscheidungswege', ar: 'مسارات قرار بسيطة جدًا' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'In der Matrixorganisation sind Mitarbeiter gleichzeitig einer Funktions- und einer Projektleitung unterstellt (Mehrfachunterstellung). Dies kann zu Kompetenzkonflikten und unklaren Weisungsbefugnissen führen.',
      ar: 'في التنظيم المصفوفي يخضع الموظفون في نفس الوقت لقيادة وظيفية وقيادة مشروع (تبعية متعددة). يمكن أن يؤدي ذلك إلى تضارب الصلاحيات وعدم وضوح سلطة التوجيه.',
    },
  },
  {
    id: 'p3-158',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was ist das Kennzeichen einer Einlinienorganisation?',
      ar: 'ما السمة المميزة للتنظيم الخطي أحادي الخط؟',
    },
    options: [
      { de: 'Jeder Mitarbeiter hat genau einen Vorgesetzten (Einheit der Auftragserteilung)', ar: 'لكل موظف رئيس واحد بالضبط (وحدة إصدار الأوامر)' },
      { de: 'Jeder Mitarbeiter hat mehrere Vorgesetzte', ar: 'لكل موظف عدة رؤساء' },
      { de: 'Es gibt keine Hierarchie', ar: 'لا يوجد تسلسل هرمي' },
      { de: 'Alle Entscheidungen werden demokratisch getroffen', ar: 'جميع القرارات تُتخذ ديمقراطيًا' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Die Einlinienorganisation (nach Fayol) zeichnet sich durch das Prinzip der Einheit der Auftragserteilung aus: Jeder Mitarbeiter hat genau einen Vorgesetzten. Die Kommunikationswege sind klar, aber oft lang.',
      ar: 'يتميز التنظيم الخطي أحادي الخط (وفقًا لفايول) بمبدأ وحدة إصدار الأوامر: لكل موظف رئيس واحد بالضبط. مسارات الاتصال واضحة ولكنها غالبًا طويلة.',
    },
  },
  {
    id: 'p3-159',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Welche Aufgabe haben Stabsstellen in der Stablinienorganisation?',
      ar: 'ما مهمة الوحدات الاستشارية في التنظيم الخطي الاستشاري؟',
    },
    options: [
      { de: 'Sie beraten und unterstützen die Leitungsstellen, haben aber kein Weisungsrecht', ar: 'تقدم المشورة والدعم لمراكز القيادة ولكن ليس لها حق إصدار الأوامر' },
      { de: 'Sie übernehmen die vollständige Leitung einer Abteilung', ar: 'تتولى القيادة الكاملة لقسم ما' },
      { de: 'Sie kontrollieren die Geschäftsführung', ar: 'تراقب إدارة الشركة' },
      { de: 'Sie ersetzen den Betriebsrat', ar: 'تحل محل مجلس العمال' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Stabsstellen (z. B. Rechtsabteilung, Controlling) haben in der Stablinienorganisation eine beratende und unterstützende Funktion für die Linienstellen. Sie besitzen kein eigenes Weisungsrecht gegenüber anderen Stellen.',
      ar: 'الوحدات الاستشارية (مثل القسم القانوني والرقابة الداخلية) لها في التنظيم الخطي الاستشاري وظيفة استشارية وداعمة للوحدات الخطية. ليس لها حق إصدار أوامر تجاه الوحدات الأخرى.',
    },
  },
  {
    id: 'p3-160',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was regelt die Ablauforganisation in einem Unternehmen?',
      ar: 'ماذا ينظم التنظيم الإجرائي في الشركة؟',
    },
    options: [
      { de: 'Die zeitliche und räumliche Gestaltung von Arbeitsprozessen', ar: 'التصميم الزمني والمكاني لعمليات العمل' },
      { de: 'Die Verteilung von Aufgaben und Kompetenzen auf Stellen', ar: 'توزيع المهام والصلاحيات على المناصب' },
      { de: 'Die Rechtsform des Unternehmens', ar: 'الشكل القانوني للشركة' },
      { de: 'Die Höhe der Mitarbeitergehälter', ar: 'مقدار رواتب الموظفين' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Die Ablauforganisation legt fest, wann, wo und in welcher Reihenfolge Arbeitsprozesse durchgeführt werden. Im Gegensatz dazu regelt die Aufbauorganisation die hierarchische Struktur (Stellen, Abteilungen).',
      ar: 'التنظيم الإجرائي يحدد متى وأين وبأي ترتيب يتم تنفيذ عمليات العمل. في المقابل ينظم التنظيم الهيكلي البنية الهرمية (المناصب والأقسام).',
    },
  },

  // --- group08: Steuern (4 more) ---
  {
    id: 'p3-161',
    exam: 'ap2',
    part: 'part3',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Wie hoch ist der ermäßigte Umsatzsteuersatz in Deutschland?',
      ar: 'كم يبلغ معدل ضريبة القيمة المضافة المخفض في ألمانيا؟',
    },
    options: [
      { de: '7 %', ar: '7%' },
      { de: '5 %', ar: '5%' },
    ...
    correctAnswers: [0],
    explanation: {
      de: 'Der ermäßigte Umsatzsteuersatz in Deutschland beträgt 7 % und gilt u. a. für Lebensmittel (außer Getränke und Gastronomie), Bücher, Zeitschriften und den öffentlichen Nahverkehr. Der Regelsteuersatz beträgt 19 %.',
      ar: 'يبلغ معدل ضريبة القيمة المضافة المخفض في ألمانيا 7% وينطبق على المواد الغذائية (باستثناء المشروبات والمطاعم) والكتب والمجلات والنقل العام القريب. المعدل العادي هو 19%.',
    },
  },
  {
    id: 'p3-162',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Wer ist zur Zahlung der Gewerbesteuer verpflichtet?',
      ar: 'من الملزم بدفع ضريبة الأعمال؟',
    },
    options: [
      { de: 'Jeder Gewerbebetrieb, der im Inland betrieben wird', ar: 'كل منشأة تجارية تعمل داخل البلاد' },
      { de: 'Nur Kapitalgesellschaften mit mehr als 50 Mitarbeitern', ar: 'فقط الشركات الرأسمالية التي تضم أكثر من 50 موظفًا' },
      { de: 'Freiberufler wie Ärzte und Rechtsanwälte', ar: 'أصحاب المهن الحرة مثل الأطباء والمحامين' },
      { de: 'Nur Unternehmen mit Sitz im Ausland', ar: 'فقط الشركات التي مقرها في الخارج' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Die Gewerbesteuer wird nach § 2 GewStG von jedem stehenden Gewerbebetrieb erhoben, der im Inland betrieben wird. Freiberufler und land- und forstwirtschaftliche Betriebe sind nicht gewerbesteuerpflichtig.',
      ar: 'تُفرض ضريبة الأعمال وفقًا للمادة 2 من قانون ضريبة الأعمال على كل منشأة تجارية مستقرة تعمل داخل البلاد. أصحاب المهن الحرة والمنشآت الزراعية والحراجية غير ملزمين بضريبة الأعمال.',
    },
  },
  {
    id: 'p3-163',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Welche Steuerklasse wird einem ledigen Arbeitnehmer ohne Kinder zugeordnet?',
      ar: 'أي فئة ضريبية يتم تصنيف العامل الأعزب بدون أطفال فيها؟',
    },
    options: [
      { de: 'Steuerklasse I', ar: 'الفئة الضريبية الأولى' },
      { de: 'Steuerklasse III', ar: 'الفئة الضريبية الثالثة' },
      { de: 'Steuerklasse IV', ar: 'الفئة الضريبية الرابعة' },
      { de: 'Steuerklasse V', ar: 'الفئة الضريبية الخامسة' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Steuerklasse I gilt für ledige, geschiedene oder verwitwete Arbeitnehmer ohne Kinder. Steuerklasse II ist für Alleinerziehende, III und V für Ehepaare mit unterschiedlicher Kombination, IV für Ehepaare mit gleicher Kombination.',
      ar: 'الفئة الضريبية الأولى تنطبق على العمال غير المتزوجين أو المطلقين أو الأرامل بدون أطفال. الفئة الثانية للوالد الوحيد والثالثة والخامسة للأزواج بتوليفة مختلفة والرابعة للأزواج بتوليفة متساوية.',
    },
  },
  {
    id: 'p3-164',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Wie hoch ist der Körperschaftsteuersatz in Deutschland?',
      ar: 'كم يبلغ معدل ضريبة الشركات في ألمانيا؟',
    },
    options: [
      { de: '15 %', ar: '15%' },
      { de: '19 %', ar: '19%' },
    ...
    correctAnswers: [0],
    explanation: {
      de: 'Der Körperschaftsteuersatz in Deutschland beträgt einheitlich 15 % auf das zu versteuernde Einkommen juristischer Personen (z. B. GmbH, AG). Hinzu kommt der Solidaritätszuschlag von 5,5 % auf die Körperschaftsteuer.',
      ar: 'يبلغ معدل ضريبة الشركات في ألمانيا 15% بشكل موحد على الدخل الخاضع للضريبة للأشخاص الاعتباريين (مثل شركة ذات مسؤولية محدودة وشركة مساهمة). يُضاف إليها رسم التضامن بنسبة 5.5% من ضريبة الشركات.',
    },
  },

  // --- group10: Personalwesen (4 more) ---
  {
    id: 'p3-165',
    exam: 'ap2',
    part: 'part3',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was bedeutet die Formulierung "Er erledigte seine Aufgaben stets zu unserer vollsten Zufriedenheit" in einem Arbeitszeugnis?',
      ar: 'ما معنى صياغة "أنجز مهامه دائمًا بما يرضينا تمامًا" في شهادة العمل؟',
    },
    options: [
      { de: 'Sehr gute Leistung (Note 1)', ar: 'أداء ممتاز (درجة 1)' },
      { de: 'Gute Leistung (Note 2)', ar: 'أداء جيد (درجة 2)' },
      { de: 'Befriedigende Leistung (Note 3)', ar: 'أداء مُرضٍ (درجة 3)' },
      { de: 'Ausreichende Leistung (Note 4)', ar: 'أداء كافٍ (درجة 4)' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Die Zeugnissprache verwendet bestimmte Formulierungen als Codes: "stets zu unserer vollsten Zufriedenheit" = Note 1 (sehr gut), "stets zu unserer vollen Zufriedenheit" = Note 2 (gut), "zu unserer vollen Zufriedenheit" = Note 3.',
      ar: 'تستخدم لغة شهادات العمل صياغات محددة كرموز: "دائمًا بما يرضينا تمامًا" = درجة 1 (ممتاز) و"دائمًا بما يرضينا بالكامل" = درجة 2 (جيد) و"بما يرضينا بالكامل" = درجة 3.',
    },
  },
  {
    id: 'p3-166',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was ist das Ziel einer beruflichen Fortbildung?',
      ar: 'ما هدف التطوير المهني؟',
    },
    options: [
      { de: 'Erweiterung oder Anpassung der beruflichen Kenntnisse und Fähigkeiten im bisherigen Berufsfeld', ar: 'توسيع أو تكييف المعارف والمهارات المهنية في المجال الوظيفي الحالي' },
      { de: 'Erlernen eines völlig neuen Berufs', ar: 'تعلم مهنة جديدة تمامًا' },
      { de: 'Verkürzung der Arbeitszeit', ar: 'تقليص ساعات العمل' },
      { de: 'Automatische Gehaltserhöhung', ar: 'زيادة تلقائية في الراتب' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Fortbildung nach § 1 Abs. 4 BBiG dient dazu, die berufliche Handlungsfähigkeit zu erhalten und anzupassen (Anpassungsfortbildung) oder zu erweitern und beruflich aufzusteigen (Aufstiegsfortbildung, z. B. Meister, Fachwirt).',
      ar: 'التطوير المهني وفقًا للمادة 1 فقرة 4 من قانون التدريب المهني يهدف إلى الحفاظ على القدرة المهنية وتكييفها (تطوير تكيفي) أو توسيعها والترقي مهنيًا (تطوير ترقوي مثل الماجستير الحرفي والخبير التجاري).',
    },
  },
  {
    id: 'p3-167',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Welche Frage ist in einem Vorstellungsgespräch nach dem AGG unzulässig?',
      ar: 'أي سؤال غير مسموح به في مقابلة العمل وفقًا لقانون المساواة في المعاملة؟',
    },
    options: [
      { de: 'Planen Sie in nächster Zeit schwanger zu werden?', ar: 'هل تخططين للحمل في المستقبل القريب؟' },
      { de: 'Welche Berufserfahrung bringen Sie mit?', ar: 'ما الخبرة المهنية التي تملكها؟' },
      { de: 'Warum möchten Sie bei uns arbeiten?', ar: 'لماذا تريد العمل لدينا؟' },
      { de: 'Welche Gehaltsvorstellung haben Sie?', ar: 'ما هي توقعاتك بشأن الراتب؟' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Nach dem Allgemeinen Gleichbehandlungsgesetz (AGG) sind Fragen nach Schwangerschaft, Religion, ethnischer Herkunft, Behinderung oder sexueller Orientierung grundsätzlich unzulässig, da sie diskriminierend sein können.',
      ar: 'وفقًا لقانون المساواة في المعاملة العامة تعتبر الأسئلة عن الحمل والدين والأصل العرقي والإعاقة أو التوجه الجنسي غير مسموح بها أساسًا لأنها قد تكون تمييزية.',
    },
  },
  {
    id: 'p3-168',
    ...
    type: 'multiple-choice',
    question: {
      de: 'Was unterscheidet eine Umschulung von einer Fortbildung?',
      ar: 'ما الذي يميز إعادة التأهيل عن التطوير المهني؟',
    },
    options: [
      { de: 'Eine Umschulung führt zu einem neuen Berufsabschluss in einem anderen Berufsfeld', ar: 'إعادة التأهيل تؤدي إلى شهادة مهنية جديدة في مجال مهني آخر' },
      { de: 'Eine Umschulung dauert immer nur einen Tag', ar: 'إعادة التأهيل تستغرق دائمًا يومًا واحدًا فقط' },
      { de: 'Eine Umschulung ist nur für Akademiker möglich', ar: 'إعادة التأهيل ممكنة فقط للأكاديميين' },
      { de: 'Eine Umschulung wird immer vom Arbeitgeber bezahlt', ar: 'يتم دفع تكاليف إعادة التأهيل دائمًا من قبل صاحب العمل' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Eine Umschulung (§ 1 Abs. 5 BBiG) qualifiziert für eine andere berufliche Tätigkeit und führt zu einem neuen Berufsabschluss. Eine Fortbildung hingegen baut auf dem bestehenden Beruf auf und vertieft oder erweitert vorhandene Kenntnisse.',
      ar: 'إعادة التأهيل (المادة 1 فقرة 5 من قانون التدريب المهني) تؤهل لنشاط مهني آخر وتؤدي إلى شهادة مهنية جديدة. أما التطوير المهني فيبني على المهنة الحالية ويعمق أو يوسع المعارف الموجودة.',
    },
  },
];
